        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.symmetric(horizontal: 30.w),
              child: Text("We help you find your dream job according to your skillset, location and prefeance to build your career",
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    color: Color(kLight.value),
                    child: Center(
                      child: ReusableText(text: "Sign Up", style: appstyle(16, Color(kLightBlue.value), FontWeight.w600)
                    ),
                  )
                )
                )
